							...
							<table width="494">
								<tr>
									...
									<td width="437" valign="bottom"><font color="#66583D"><b>部门管理&nbsp;</b></font>&gt;
										<font color="#FF0000"> 部门修改</font></td>
								</tr>
							</table>
						</td>
					</tr>
				</table>
				<form action="/person_manager/ubook" method="post">
						...
						<td height="436" valign="top" align="center">
								...
								<table width="355" border="1" cellpadding="1" cellspacing="1"
									...
									<tr>
										...
										<td width="263" bgcolor="#FFFFFF"><input type="text" value='${department.dt_name}' name="department.dt_name" id="name"/></td>
									</tr>
									<tr>
										<th height="30"><span class="word_white">创建时间：</span></th>
										<td bgcolor="#FFFFFF"><input type="text" value='${department.dt_createTime}' name="department.dt_createTime" /></td>
									</tr>
									<tr>
										<th height="30"><span class="word_white">备注信息：</span></th>
										<td bgcolor="#FFFFFF"><input type="text" value='${department.dt_bz}' name="department.dt_bz" id="bz"/></td>
									</tr>
								</table>
								
								<br>
								<input type="button" value="保存" onclick="save('${department.id}')">
                              &nbsp;&nbsp;
